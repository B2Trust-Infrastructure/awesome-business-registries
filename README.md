...
| **Bulk data**  | 📦 data.brreg.no — full dataset download (~1M entities)                                                                        |
...
| **Bulk data** | 📦 CVR Open Data — full company dataset (~800K companies)                                                                |
...
| **Auth**      | 🟢 Open access                                                                    |
| **Format**    | REST/JSON                                                                         |
| **Bulk data** | 📦 Available via avoindata.prh.fi (~600K companies)                               |
| **Docs**      | avoindata.prh.fi/index.html                                                       |
...
| ------------------- | --------------------------------------------- | ------- | ------------ | ---------------- |
| 🇬🇧 UK             | Companies House bulk data                     | ~5.4M   | CSV          | Monthly          |
| 🇫🇷 France         | SIRENE (data.gouv.fr)                         | ~25M    | CSV          | Monthly          |
| 🇩🇪 Germany        | OffeneRegister.de                             | ~5.3M   | JSONL        | Periodic         |
| 🇵🇱 Poland         | KRS + CEIDG + GUS dumps                       | ~3.1M   | CSV/XML/JSON | Nightly          |
| 🇳🇴 Norway         | data.brreg.no                                 | ~1M     | JSON         | Daily            |
| 🇨🇿 Czech Republic | data.gov.cz                                   | ~2.7M   | XML/CSV      | Regular          |
| 🇪🇪 Estonia        | [avaandmed.rik.ee](https://avaandmed.rik.ee/) | ~353K   | CSV/JSON     | Regular          |
| 🇩🇰 Denmark        | CVR Open Data                                 | ~800K   | JSON         | Regular          |
| 🇫🇮 Finland        | avoindata.prh.fi                              | ~600K   | JSON         | Regular          |
| 🇸🇰 Slovakia       | [data.gov.sk](https://data.gov.sk/)           | ~500K   | CSV          | Regular          |
| 🇧🇷 Brazil         | CNPJ Open Data                                | ~50M    | CSV          | Monthly          |
